...
const config = {
  ...
  organizationName: 'zhuzhux', // Usually your GitHub org/user name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/zhuzhux/state-management-collection/tree/main/website/',
        },
        theme: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/zhuzhux/state-management-collection.git',
            label: 'GitHub',
            position: 'right',
          },
        ],
